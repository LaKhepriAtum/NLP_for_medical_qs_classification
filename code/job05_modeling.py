...
X_train, X_test, Y_train, Y_test = np.load(
    '../output/medical_data_max_817_word_size31717.npy',
    allow_pickle=True)
print(X_train.shape, Y_train.shape)
print(X_test.shape, Y_test.shape)

model = Sequential()
model.add(Embedding(31717, 300, input_length=817)) # 12537 =>단어의 개수, 전체의 단어가 12537, 각각의 단어에 값을 부여 12537개의 차원
...
model.save('../output/medical_category_classification_model_{}.h5'.format(fit_hist.history['val_accuracy'][-1]))
